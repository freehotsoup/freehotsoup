...
t1 = Ticket(item='13 hats assorted colors', deliverer='Bonnie', gyfter='Ashika',
            ...
            dropoff_date='11/11/17',pickup_options='Needs delivered', gyfter_comments='New ticket comments...', requester_comments='Match ticket comments...', ticket_type='donation')
...
t2 = Ticket(item='11 coats assorted colors', deliverer='Michael',
            ...
            dropoff_date='11/12/17',pickup_options='Needs delivered',gyfter_comments='New ticket comments...', requester_comments='Match ticket comments...', ticket_type='donation')
...
t3 = Ticket(item='3 pairs size 11 womens shoes', deliverer='Jason',
            ...
            dropoff_address='pioneer courthouse square',requester_phone='', dropoff_time='11pm',
            dropoff_date='11/11/17',pickup_options='Needs delivered', requester_comments='New ticket comments...', gyfter_comments='Match ticket comments...', ticket_type='request')
...
t4 = Ticket(item='a partridge in a pear tree', deliverer='Ashika',
            ...
            dropoff_date='11/12/17',pickup_options='Needs delivered', requester_comments='New ticket comments...', gyfter_comments='Match ticket comments...', ticket_type='request')
...
t5 = Ticket(item='a nice warm L mens winter coat black', deliverer='',
            ...
            dropoff_date='',pickup_options='Needs delivered',gyfter_comments='New ticket comments...', requester_comments='Match ticket comments...', ticket_type='donation')

t6 = Ticket(item='a blue L mens tucker hat', deliverer='',
            gyfter='Mr. Tester', pickup_address='The fields Park',gyfter_phone='',
            ...
            dropoff_date='1/11/18',pickup_options='',gyfter_comments='New ticket comments...', requester_comments='Match ticket comments...', ticket_type='donation')
