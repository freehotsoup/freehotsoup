...
t1 = Ticket(item='5 gallons of vegetable soup', deliverer='Bonnie', gyfter='Ashika',
            ...
            dropoff_date='11/11/17',pickup_options='Needs delivered', gyfter_comments='New ticket comments...', requester_comments='Match Found ticket comments...', exchange_time='9am', exchange_date='11/12/17', ticket_type='donation')
...
t2 = Ticket(item='11 coats assorted colors', deliverer='Michael',
            ...
            dropoff_date='11/12/17',pickup_options='Needs delivered',gyfter_comments='New ticket comments...', requester_comments='Match Found ticket comments...', exchange_time='9am', exchange_date='11/12/17', ticket_type='donation')
...
t3 = Ticket(item='3 pairs size 11 womens shoes', deliverer='Mary',
            ...
            dropoff_address='pioneer courthouse square',requester_phone='0987654321', dropoff_time='11pm',
            dropoff_date='11/11/17',pickup_options='Needs delivered', requester_comments='New ticket comments...', gyfter_comments='Match Found ticket comments...', exchange_time='9am', exchange_date='11/12/17', ticket_type='request')
...
t4 = Ticket(item='Winter Hat', deliverer='Ashika',
            ...
            dropoff_date='11/12/17',pickup_options='Needs delivered', requester_comments='New ticket comments...', gyfter_comments='Match Found ticket comments...', exchange_time='9am', exchange_date='11/12/17', ticket_type='request')
...
t5 = Ticket(item='a nice warm mens winter coat black size large', deliverer='Sarah',
            ...
            dropoff_date='12/12/17',pickup_options='Needs delivered',gyfter_comments='New ticket comments...', requester_comments='Match Found ticket comments...', exchange_time='9am', exchange_date='11/12/17', ticket_type='donation')
...
t6 = Ticket(item='a blue womens summer hat size medium', deliverer='Monica',
            ...
            dropoff_date='11/14/17',pickup_options='Can pick up',gyfter_comments='New ticket comments...', requester_comments='Match Found ticket comments...', exchange_time='9am', exchange_date='11/12/17', ticket_type='donation')
